...
library(dplyr); library(rvest); library(magrittr)
```
...
<span class="fragment fade-in">Structured -- typical data formats</span>

<span class="fragment fade-in">Semi-structured -- modern sites</span>

<span class="fragment fade-in">Unstructured -- varying levels of doom</span>
...
DT::datatable(bankList, style = "bootstrap")
```
...
<video src="https://zippy.gfycat.com/NaiveGloriousBallpython.webm" loop="true"
onclick="this.play()">
</video>
...
<span class="neonBlue">Thank You</span>
</span>
</section>